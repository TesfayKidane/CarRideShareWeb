...
//    private List<Ride> items = new ArrayList<Ride>();
    ...
    private Category parentCategory;
     ...
     @Transient
    private Map<Ride,User> itemsAndUser = new HashMap<Ride,User>();
...
//    public List<Ride> getItems() { return items; }
//    public void addItem(Ride item) {
//        if (item == null) throw new IllegalArgumentException("Null item!");
//        items.add(item);
//        item.getCategories().add(this);
//    }
//    public void removeItem(Ride item) {
//        if (item == null) throw new IllegalArgumentException("Null item!");
//        items.remove(item);
