				  ...
				  <div class="container">
					<c:choose>
					    ...
					    <c:otherwise>
		 					...
		 					<br>
		 					<a href="<spring:url value="/rides/add" />" class="btn btn-default pull-right">Add ride</a>	
		 					<a href="<spring:url value="/rides/all" />" class="btn btn-default pull-right">ride List</a>	
		 					<br>
