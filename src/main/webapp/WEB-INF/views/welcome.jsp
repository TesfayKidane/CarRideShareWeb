				  ...
				  <ul>
					<c:choose>
					    <c:when test="${empty user}">
      					<li class=""><a href="<spring:url value='/login' />" class="btn btn-default pull-right"> Login</a></li></br>
					    </c:when>
					    <c:otherwise>
		 					<li class=""><a href="<spring:url value="/users/add" />" class="btn btn-default pull-right">Add User</a></li></br>	
		 					<li class=""><a href="<spring:url value="/users" />" class="btn btn-default pull-right">User List</a></li>	
		 					<br>
		 					<li class=""><a href="<spring:url value="/rides/add" />" class="btn btn-default pull-right">Add Ride</a></li>	
		 					<li class=""><a href="<spring:url value="/rides/all" />" class="btn btn-default pull-right">Ride List</a></li>	
		 					<br>
		 					<li class=""><a href="<spring:url value='/logout' />" class="btn btn-default pull-right"> Logout</a></li>		 
 					    </c:otherwise>
					</c:choose>	
					</ul>
